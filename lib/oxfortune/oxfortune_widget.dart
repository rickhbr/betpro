...
import 'oxfortune_model.dart';
export 'oxfortune_model.dart';

class OxfortuneWidget extends StatefulWidget {
  const OxfortuneWidget({
    Key? key,
    required this.pNome,
  }) : super(key: key);
  ...
  @override
  _OxfortuneWidgetState createState() => _OxfortuneWidgetState();
}

class _OxfortuneWidgetState extends State<OxfortuneWidget> {
  late OxfortuneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OxfortuneModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.outImgActionPageLoad = await actions.randomImage(
        FFAppState().oxfortuneAppState.toList(),
      );
      setState(() {
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FlutterFlowWebView(
                                content:
                                    'https://universo.bet/game/pgsoft-fortune-ox',
                                bypass: false,
                                height: 500.0,
