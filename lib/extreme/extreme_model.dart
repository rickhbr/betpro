...
class ExtremeModel extends FlutterFlowModel {
  ...
  // Stores action output result for [Backend Call - API (Extreme)] action in Extreme widget.
  ApiCallResponse? apiResultljv;
  // Stores action output result for [Custom Action - actionSplit] action in Extreme widget.
  ...
  // Stores action output result for [Backend Call - API (Extreme)] action in Timer widget.
