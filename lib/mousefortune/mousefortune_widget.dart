...
import 'mousefortune_model.dart';
export 'mousefortune_model.dart';

class MousefortuneWidget extends StatefulWidget {
  const MousefortuneWidget({
    Key? key,
    required this.pNome,
  }) : super(key: key);
  ...
  @override
  _MousefortuneWidgetState createState() => _MousefortuneWidgetState();
}

class _MousefortuneWidgetState extends State<MousefortuneWidget> {
  late MousefortuneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MousefortuneModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.outImgActionPageLoad = await actions.randomImage(
        FFAppState().mousefortuneAppState.toList(),
      );
      setState(() {
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FlutterFlowWebView(
                                content:
                                    'https://universo.bet/game/pgsoft-fortune-mouse',
                                bypass: false,
                                height: 500.0,
