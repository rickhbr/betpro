...
class BacboModel extends FlutterFlowModel {
  ...
  String? firstResulStringLocalState = 'Vazio';

  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Backend Call - API (Bac Bo)] action in BACBO widget.
  ApiCallResponse? apiResultljv;
  // Stores action output result for [Custom Action - actionSplit] action in BACBO widget.
  ...
  // Stores action output result for [Backend Call - API (Bac Bo)] action in Timer widget.
