...
class _CadastroWidgetState extends State<CadastroWidget> {
  ...
  void initState() {
    ...
    _model.txtZapController ??= TextEditingController();
    _model.txtEmailController ??= TextEditingController();
    _model.txtSenhaController ??= TextEditingController();
    _model.txtConfirmarSenhaController ??= TextEditingController();
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: TextFormField(
                                        controller: _model.txtZapController,
                                        autofocus: true,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          isDense: true,
                                          labelStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelMedium,
                                          hintText:
                                              'Adicione seu número e parrticipe dos sorteios',
                                          hintStyle:
                                              FlutterFlowTheme.of(context)
                                                  .labelMedium,
                                          enabledBorder: OutlineInputBorder(
                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: TextFormField(
                                        controller:
                                            _model.txtConfirmarSenhaController,
                                        autofocus: true,
                                        obscureText:
                                        ...
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium,
                                        validator: _model
                                            .txtConfirmarSenhaControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ],
