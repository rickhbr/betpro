...
export 'aviator_model.dart';

class AviatorWidget extends StatefulWidget {
  const AviatorWidget({
    Key? key,
    required this.pNome,
  }) : super(key: key);
  ...
  @override
  _AviatorWidgetState createState() => _AviatorWidgetState();
}

class _AviatorWidgetState extends State<AviatorWidget> {
  late AviatorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AviatorModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.outImgActionPageLoad = await actions.randomImage(
        FFAppState().aviatorAppState.toList(),
      );
      setState(() {
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FlutterFlowWebView(
                                content:
                                    'https://universo.bet/game/spribe-aviator',
                                bypass: false,
                                height: 500.0,
