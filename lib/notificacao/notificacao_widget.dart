...
class _NotificacaoWidgetState extends State<NotificacaoWidget> {
  ...
  void initState() {
    ...
    _model.txtNotificaoTypeController ??= TextEditingController();
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: TextFormField(
                            controller: _model.txtNotificaoTypeController,
                            autofocus: true,
                            obscureText: false,
                            ...
                            validator: _model
                                .txtNotificaoTypeControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ],
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              triggerPushNotification(
                                notificationTitle:
                                    _model.txtNotificaoTypeController.text,
                                notificationText: _model.textController2.text,
                                notificationSound: 'default',
                                userRefs: _model.outUsers!
                                    .map((e) => e.reference)
                                    .toList(),
