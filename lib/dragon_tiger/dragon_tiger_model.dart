...
class DragonTigerModel extends FlutterFlowModel {
  ...
  // Stores action output result for [Backend Call - API (Dragon Tiger)] action in DragonTiger widget.
  ApiCallResponse? apiResultljv;
  // Stores action output result for [Custom Action - actionSplit] action in DragonTiger widget.
  ...
  // Stores action output result for [Backend Call - API (Dragon Tiger)] action in Timer widget.
