...
import 'fortunetiger_model.dart';
export 'fortunetiger_model.dart';

class FortunetigerWidget extends StatefulWidget {
  const FortunetigerWidget({
    Key? key,
    required this.pNome,
  }) : super(key: key);
  ...
  @override
  _FortunetigerWidgetState createState() => _FortunetigerWidgetState();
}

class _FortunetigerWidgetState extends State<FortunetigerWidget> {
  late FortunetigerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FortunetigerModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.outImgActionPageLoad = await actions.randomImage(
        FFAppState().fortuneAppState.toList(),
      );
      setState(() {
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FlutterFlowWebView(
                                content:
                                    'https://universo.bet/game/pgsoft-fortune-tiger',
                                bypass: false,
                                height: 500.0,
